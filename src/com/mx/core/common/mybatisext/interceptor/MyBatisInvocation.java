...
public class MyBatisInvocation {
	...
	public MyBatisInvocation(Class<?> mapperInterface, SqlSession sqlSession, Method method, Object[] args, MyBatisInterceptor[] interceptors, Map<Method, MapperMethod> methodCache) {
