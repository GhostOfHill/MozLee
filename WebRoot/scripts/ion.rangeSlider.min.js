...
(function (f, r, h, t, v) {
  ...
  q.prototype = {
    ...
    changeLevel: function (a) {
      switch (a) {
        ...
        case 'both':
          ...
          this.coords.p_gap_right = this.toFixed(this.coords.p_to_fake -
    ...
    pointerUp: function (a) {
      if (this.current_plugin === this.plugin_count && this.is_active) {
        ...
        if (f.contains(this.$cache.cont[0], a.target) || this.dragging) this.is_finish = !0,
        this.callOnFinish();
        this.dragging = !1
      }
    },
    ...
    validate: function () {
      ...
      if (c) for (a.p_values = [
      ], a.min = 0, a.max = c - 1, a.step = 1, a.grid_num = a.max, a.grid_snap = !0, g = 0; g < c; g++) e = + d[g],
    ...
    appendGrid: function () {
      if (this.options.grid) {
        ...
        for (b = 0; b < c + 1; b++) {
          ...
          this.coords.big[b] = g;
          h = (g - e * (b - 1)) / (k + 1);
          for (d = 1; d <= k && 0 !== g; d++) m = this.toFixed(g - h * d),
    ...
    cacheGridLabels: function () {
      ...
      for (b = 0; b < d; b++) a = this.$cache.grid.find('.js-grid-text-' + b),
  ...
  (function () {
    for (var a = 0, b = [
      ...
      'webkit',
      'o'
    ], d = 0; d < b.length && !h.requestAnimationFrame; ++d) h.requestAnimationFrame = h[b[d] + 'RequestAnimationFrame'],
